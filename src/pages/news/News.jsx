...
const News = () => {
  ...
  const [search, setSearch] = useState("qatar")
...
useEffect(() => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault() // Forhindre reload af siden (skal undgås fordi det tømmer state!)
    getData("https://newsapi.org/v2/top-headlines?language=" + country +"&category=" + category + "&q=" + search + "&apiKey=" + process.env.REACT_APP_NEWSAPIKEY)
    ...
    <div className="news container">
        ...
        <div className="row mb-5">
          <form onSubmit={handleSubmit}>
            ...
            <select className='form-select' defaultValue={category} onChange={e => setCategory(e.target.value)}>
